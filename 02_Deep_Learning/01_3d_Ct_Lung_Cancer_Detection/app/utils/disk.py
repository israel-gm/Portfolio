...
#from diskcache.core import BytesType, MODE_BINARY, BytesIO #deprecated
from io import BytesIO #updated.ijmg
BytesType = bytes #updated.ijmg
MODE_BINARY = 'binary' #updated.ijmg
...
CACHE_ROOT = WORKSPACE_ROOT / "media" / "cache"
...
def getCache(scope_str):
    return FanoutCache(str(CACHE_ROOT / scope_str),
                       disk=GzipDisk,
                       shards=64,
                       timeout=1,
                       size_limit=3e11,
