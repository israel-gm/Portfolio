...
from lung_cancer_detection.utils.util import enumerateWithEstimate
from lung_cancer_detection.data.segmentation_dsets import Luna2dSegmentationDataset
from lung_cancer_detection.data.classification_dsets import LunaDataset, getCt, getCandidateInfoDict, getCandidateInfoList, CandidateInfoTuple
from lung_cancer_detection.models.segmentation_model import UNetWrapper

import lung_cancer_detection.models.classification_model

from lung_cancer_detection.utils.logconf import logging
from lung_cancer_detection.utils.util import xyz2irc, irc2xyz

np.int = int  # 👈 restore the deprecated alias for old code

log = logging.getLogger(__name__)
# log.setLevel(logging.WARN)
# log.setLevel(logging.INFO)
log.setLevel(logging.DEBUG)
logging.getLogger("lung_cancer_detection.data.segmentation_dsets").setLevel(logging.WARNING)
logging.getLogger("lung_cancer_detection.data.classification_dsets").setLevel(logging.WARNING)
...
class NoduleAnalysisApp:
    ...
    def initModels(self):
        ...
        model_cls = getattr(lung_cancer_detection.models.classification_model, self.cli_args.cls_model)
        cls_model = model_cls()
        ...
        if self.cli_args.malignancy_path:
            model_cls = getattr(lung_cancer_detection.models.classification_model, self.cli_args.malignancy_model)
