...
import lung_cancer_detection.dsets
...
class ClassificationTrainingApp:
    ...
    def initModel(self):
        model_cls = getattr(lung_cancer_detection.model, self.cli_args.model)
        model = model_cls()
    ...
    def initTrainDl(self):
        ds_cls = getattr(lung_cancer_detection.dsets, self.cli_args.dataset)
    ...
    def computeBatchLoss(self, batch_ndx, batch_tup, batch_size, metrics_g,
        ...
        if augment:
            input_g = lung_cancer_detection.model.augment3d(input_g)
